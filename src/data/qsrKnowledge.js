...
ECONOMICS: QSR industry revenue ~$532B for 2025 [verified 05/2026, NRN / Restaurant Business]; 80%+ of operators expect 2025 sales to match or exceed 2024. THE 2025 INVERSION: casual dining traffic is recovering while QSR foot traffic is declining — reverses the 2023-2024 "trade-down to QSR" pattern [verified 05/2026, Bank of America commercial banking research]. This breaks the conventional "recession = QSR tailwind" assumption. Per-store traffic declining despite loyalty member count doubling since 2019 (~39% of visits). Loyalty traffic grew 5% YoY while overall traffic fell 2%. Food cost + labor cost = largest controllable expenses; inventory discipline separates top-quartile from median by 2-4% margin points. PE portcos now require 10-12% EBITDA growth annually (vs historical 5%) given 8-9% borrowing costs. California fast-food wages reached $20/hr in 2025 [verified 05/2026, CA AB 1228]; sector-wide labor cost growth 6%+ annually. QSR labor cost growth since 2017: 60.2% vs 73.9% for full-service. Inflation peak: QSR 7.2% vs full-service 10.1%; current QSR ~3.6% vs 4.3% full-service [verified 05/2026, BLS / Restaurant Business].

DELIVERY ECONOMICS: Third-party effective commission 30-40% (headline 15-30% + promos + processing + refunds). Direct/first-party ordering via apps/websites is dominant GTM strategy — brands escape commission tiers. Starbucks stored-value loop (preloaded card breakage) is the gold standard. [verified 05/2026, Restaurant Dive / DoorDash merchant terms]

2026 TRENDS: AI drive-thru voice — Taco Bell as public reference; Toast Drive-Thru launched April 2026 as broader-market enterprise solution. AI-driven inventory and labor scheduling — MarginEdge-Qu integration (Nov 2025) for real-time profitability tracking. AI-driven loyalty + digital ordering boosted Dunkin's EBITDA margins ~8% within five years [verified 05/2026, Restaurant Business / Inspire Brands]. AI-driven inventory and self-service kiosks reducing labor costs by up to 15% in QSRs [verified 05/2026, NRN / Restaurant Dive]. Subscription models expanding (Panera Sip Club, Taco Bell Taco Lover's Pass). Agentic commerce standards from Visa/Mastercard. 70% of PE firms mandate AI adoption with 12-month margin-impact requirements [verified 05/2026, Bain PE Operating Partners Survey 2025]. Roark's operating-partner model: 20% increase in franchisee satisfaction, 10% rise in same-store sales [verified 05/2026, Roark Capital / Restaurant Business].
