...
- The "70% of PE firms mandate AI adoption" stat is from a survey of operating partners, not a census. Selection bias likely inflates the number.
- Gartner's ">40% agentic AI projects canceled by 2027" is a PREDICTION, not a measurement. Treat as directional forecast.
- Fintech multiple compression (20-40x to 5-15x) is a range across subsectors. Payments infrastructure trades higher than consumer fintech.
- CRE loan maturity wall ($957B) is a 2025 figure that shifts quarterly as extensions and refinancings occur. Confirm current figure before using.
