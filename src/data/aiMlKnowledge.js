...
1. MODEL PRICING: Token prices change monthly or faster. Frontier pricing ($3-15/M input) and mid-tier pricing shift with every model release. Re-verify against provider pricing pages before every brief that references cost.
2. ADOPTION RATES: Census BTOS methodology changed late 2025; YoY comparisons across the break are misleading. Fed FEDS Notes publishes ~2x/year; between publications, adoption figures are stale. Never extrapolate trends across methodology changes.
...
4. STARTUP VALUATIONS & FUNDING: Vertical AI investment totals (Menlo Ventures $3.5B) are calendar-year snapshots. Funding rounds close and re-price quarterly. Never cite a round size or valuation older than 90 days without re-checking.
5. REGULATORY STATUS: EU AI Act timelines shift; US state laws (CA, CO, NY) pass or stall each legislative session. The "38% cite regulatory compliance as #1 blocker" figure will move with every Deloitte quarterly pulse. Re-verify before any compliance-sensitive brief.
...
7. MARKET SHARE: NVIDIA's 80-95% AI chip share is a moving target as AMD, Intel, and custom silicon (TPU, Trainium, MTIA) gain traction. Re-verify with latest quarterly shipment data.
