...
- "50% of physicians employed by health systems" is trending upward rapidly (was ~44% a few years ago). The exact figure depends on whether locum tenens and contract physicians are counted.
- The 219% PE/VC surge to $16.9B in healthcare IT is FTI Consulting's definition of "healthcare IT." Other sources use narrower or broader definitions and arrive at different totals.
- "100% of healthcare payer CIOs" reporting AI/ML implementation is from a Gartner survey with small sample size among payer CIOs specifically. Do not generalize to all healthcare CIOs.
...
- EHR switching cost ($100M+) is for large health systems. A 5-physician practice switching EHRs costs $50K-$200K, not $100M.
