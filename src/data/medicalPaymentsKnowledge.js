...
NationsBenefits: founded 2015, Plantation FL, CEO Glenn Parker MD, ~2,500 employees [verified 05/2026, Crunchbase/PitchBook]. $328M total raised [verified 05/2026, Crunchbase]. General Atlantic (majority position since 2022), BPEA PE, Denali Growth Partners, Monroe Capital, Pritzker Organization. Est. revenue ~$200M, est. valuation ~$640M [verified 05/2026, PitchBook]. 7 acquisitions including CareCar (medical transport, Sept 2025). 11+ major retail integrations 2025-2026 (Walgreens, Dollar General, H Mart, Wakefern banners, Food City, Giant Eagle). Strategic position: clearly positioned for exit or scaling event 2026-2027 — GA hold period approaching 4-5 year mark. Likely strategic buyers: UHG/Optum, Humana, CVS, Elevance — or PE roll-up.
...
10. LSA adoption figures (10% of companies, 48% expect to offer) are survey-based from Sequoia and Compt — small sample sizes, self-selected respondents, and vendor-sponsored. Treat as directional market signal, not census data.
