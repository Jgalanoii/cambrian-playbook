...
- COGS (Cost of Goods Sold): materials + direct labor + manufacturing overhead. In most manufacturing, materials are 40-60% of COGS, making supply chain and procurement critical levers. Direct labor is declining as a percentage of COGS as automation increases, but it remains significant in labor-intensive segments (assembly, food processing).
...
- ADDITIVE MANUFACTURING (3D printing): prototyping, tooling, and increasingly production parts (especially aerospace, medical, and dental). Market growing rapidly but still <1% of total manufacturing output.
