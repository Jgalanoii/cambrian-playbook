...
ISO LANDSCAPE: ISOs (Independent Sales Organizations) are third-party sales entities sponsored by acquiring banks. Three models: Referral/Sub-ISO (earns residuals, no registration), Registered Sales-only ISO (50-70% rev-share on spread), Full-Liability ISO (owns portfolio, highest margin/risk/exit value). ISOs are being squeezed by software-led distribution (~85% of merchants now choose payments with their software) [verified 05/2026, McKinsey Global Payments], direct merchant products (Stripe/Square self-serve), and margin compression (effective rates down from 3.5%+ to 2.6-2.9%) [verified 05/2026, Nilson Report].
